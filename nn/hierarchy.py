...
class RecursiveSystem:
    ...
    def __init__(self, policy_stack, critic_stack, env_fn_stack, deterministic_stack):
        ...
        self.stack_height = len(self.policy_stack)
        #prod = 1
    ...
    def eval(self, trials, max_len, *args, deterministic=True, render=False, verbose=True, update_norm=False, mirror=False, **kwargs):
        ...
        # set deterministicness
        e = self.env_head
        for i in range(self.stack_height):
            e.evaluation_mode = True
            e.do_render_markers = render
            e = e.subenv
        ...
        # reset deterministicness
        e = self.env_head
        for i in range(self.stack_height):
            e.evaluation_mode = False
            e.do_render_markers = False
            e = e.subenv
