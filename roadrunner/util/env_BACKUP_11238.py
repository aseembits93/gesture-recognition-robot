...
def env_factory(**kwargs):
    ...
    if 'cassie_FFWalk' == path.lower():
        from envs.envs import CassieFFWalkEnv
        if True:
            print("Created cassie_FF_base with arguments:")
            print("\tsimrate:                {}".format(kwargs['simrate']))
            #print("\treward:                 {}".format(kwargs['reward']))
            print("\tdynamics randomization: {}".format(kwargs['dynamics_randomization']))
            print("\timpedance control:      {}".format(kwargs['impedance']))
        ...
        return partial(CassieFFWalkEnv, **kwargs)

    if 'Cassie3StepEnv' == path.lower():
        from envs.envs import Cassie3StepEnv
        if True:
            print("Created Cassie3StepEnv with arguments:")
            print("\tsimrate:                {}".format(kwargs['simrate']))
            #print("\treward:                 {}".format(kwargs['reward']))
            print("\tdynamics randomization: {}".format(kwargs['dynamics_randomization']))
            print("\timpedance control:      {}".format(kwargs['impedance']))
        ...
        return partial(Cassie3StepEnv, **kwargs)
